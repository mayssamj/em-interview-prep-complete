...
export async function seedSystemDesignContent() {
  ...
  for (const framework of frameworks) {
    await prisma.system_design_frameworks.upsert({
      ...
      create: {
        ...framework,
        id: framework.name.toLowerCase().replace(/\s+/g, '_'),
        updated_at: new Date()
      }
    });
  }
  ...
  const systemDesignQuestions = [
      ...
      questions: [
        {
          ...
          system_design_details: {
            architecture_focus: ["distributed_systems", "real_time_processing", "recommendation_systems", "caching"],
            complexity_level: "senior",
            leadership_aspects: ["technical_decision_making", "cross_functional_collaboration", "stakeholder_management"],
            frameworks: ["microservices", "event_driven_architecture", "caching_strategies"],
            evaluation_criteria: ["scalability", "real_time_performance", "personalization_quality", "system_reliability"],
        ...
        {
          question_text: "Design Meta Messenger or a similar large-scale chat system.",
          category: "real_time_systems",
          difficulty: "Hard",
          is_critical: true,
          tags: ["messaging", "real_time", "websockets", "mobile"],
          system_design_details: {
            architecture_focus: ["real_time_communication", "mobile_optimization", "message_delivery", "presence_system"],
            complexity_level: "senior",
            leadership_aspects: ["technical_decision_making", "mobile_team_coordination", "infrastructure_planning"],
            frameworks: ["websockets", "message_queues", "eventual_consistency"],
            evaluation_criteria: ["message_delivery_reliability", "real_time_performance", "mobile_battery_optimization", "scalability"],
            estimated_time_minutes: 45,
            follow_up_questions: [
    ...
    // Amazon questions
    {
      ...
      questions: [
        {
          question_text: "Design a scalable e-commerce product page with real-time inventory and recommendations.",
          category: "e_commerce",
          difficulty: "Hard",
          is_critical: true,
          tags: ["e_commerce", "inventory", "recommendations", "real_time"],
          system_design_details: {
            architecture_focus: ["inventory_management", "recommendation_systems", "caching", "real_time_updates"],
            complexity_level: "senior",
            leadership_aspects: ["product_team_collaboration", "business_metrics_optimization", "customer_experience"],
            frameworks: ["microservices", "caching_strategies", "event_driven_architecture"],
            evaluation_criteria: ["page_load_performance", "inventory_accuracy", "recommendation_relevance", "conversion_optimization"],
            estimated_time_minutes: 45,
            follow_up_questions: [
        ...
        },
        {
          ...
          system_design_details: {
            architecture_focus: ["global_distribution", "caching_strategies", "edge_computing", "content_optimization"],
            complexity_level: "senior",
            leadership_aspects: ["infrastructure_planning", "cost_optimization", "global_team_coordination"],
            frameworks: ["caching_strategies", "load_balancing", "geographic_distribution"],
            evaluation_criteria: ["content_delivery_speed", "global_availability", "cost_efficiency", "cache_hit_ratio"],
            estimated_time_minutes: 45,
            follow_up_questions: [
    ...
    // Google questions
    {
      ...
      questions: [
        {
          question_text: "Design Google Maps.",
          category: "geospatial_systems",
          difficulty: "Hard",
          is_critical: true,
          tags: ["maps", "geospatial", "routing", "real_time"],
          system_design_details: {
            architecture_focus: ["geospatial_indexing", "routing_algorithms", "real_time_traffic", "mobile_optimization"],
            complexity_level: "senior",
            leadership_aspects: ["cross_functional_coordination", "data_partnerships", "privacy_considerations"],
            frameworks: ["geospatial_databases", "graph_algorithms", "real_time_processing"],
            evaluation_criteria: ["routing_accuracy", "real_time_performance", "data_freshness", "mobile_experience"],
            estimated_time_minutes: 45,
            follow_up_questions: [
        ...
        {
          question_text: "Design YouTube or a large-scale video streaming platform.",
          category: "media_streaming",
          difficulty: "Hard",
          is_critical: true,
          tags: ["video_streaming", "cdn", "encoding", "recommendations"],
          system_design_details: {
            architecture_focus: ["video_processing", "content_delivery", "recommendation_systems", "live_streaming"],
            complexity_level: "senior",
            leadership_aspects: ["content_creator_ecosystem", "monetization_strategy", "global_infrastructure"],
            frameworks: ["video_encoding", "cdn_optimization", "recommendation_engines"],
            evaluation_criteria: ["video_quality", "streaming_performance", "content_discovery", "creator_satisfaction"],
            estimated_time_minutes: 45,
            follow_up_questions: [
    ...
    // Microsoft questions
    {
      ...
      questions: [
        {
          question_text: "Design a system for real-time document co-authoring (like Office 365).",
          category: "collaboration_systems",
          difficulty: "Hard",
          is_critical: true,
          tags: ["collaboration", "real_time", "conflict_resolution", "office"],
          system_design_details: {
            architecture_focus: ["operational_transformation", "conflict_resolution", "real_time_sync", "version_control"],
            complexity_level: "senior",
            leadership_aspects: ["user_experience_optimization", "enterprise_requirements", "security_compliance"],
            frameworks: ["operational_transformation", "conflict_resolution", "real_time_communication"],
            evaluation_criteria: ["collaboration_smoothness", "conflict_resolution_accuracy", "real_time_performance", "data_consistency"],
            estimated_time_minutes: 45,
            follow_up_questions: [
        ...
        },
        {
          ...
          system_design_details: {
            architecture_focus: ["metrics_collection", "alerting_systems", "data_visualization", "anomaly_detection"],
            complexity_level: "mid",
            leadership_aspects: ["devops_culture", "incident_response", "cost_optimization"],
            frameworks: ["time_series_databases", "alerting_systems", "data_aggregation"],
            evaluation_criteria: ["monitoring_coverage", "alert_accuracy", "query_performance", "cost_efficiency"],
    ...
    // OpenAI questions
    {
      ...
      questions: [
        {
          question_text: "Design a system to serve a large language model (e.g., GPT-4) to millions of users with low latency.",
          category: "ai_systems",
          difficulty: "Hard",
          is_critical: true,
          tags: ["llm", "ai_inference", "gpu_optimization", "latency"],
          system_design_details: {
            architecture_focus: ["model_serving", "gpu_optimization", "request_batching", "caching_strategies"],
            complexity_level: "senior",
            leadership_aspects: ["ai_infrastructure", "cost_optimization", "safety_considerations"],
            frameworks: ["model_serving", "gpu_optimization", "request_batching"],
            evaluation_criteria: ["inference_latency", "throughput", "cost_efficiency", "model_quality"],
            estimated_time_minutes: 45,
            follow_up_questions: [
        ...
        {
          question_text: "Design a distributed training pipeline for large AI models.",
          category: "ai_systems",
          difficulty: "Hard",
          is_critical: false,
          tags: ["distributed_training", "model_parallelism", "data_parallelism", "gpu_clusters"],
          system_design_details: {
            architecture_focus: ["distributed_training", "model_parallelism", "gradient_synchronization", "fault_tolerance"],
            complexity_level: "senior",
            leadership_aspects: ["research_infrastructure", "experiment_management", "resource_allocation"],
            frameworks: ["distributed_training", "model_parallelism", "fault_tolerance"],
            evaluation_criteria: ["training_efficiency", "fault_tolerance", "resource_utilization", "experiment_reproducibility"],
            estimated_time_minutes: 45,
            follow_up_questions: [
    ...
    // Anthropic questions
    {
      ...
      questions: [
        {
          question_text: "Design a system for safe AI model deployment with constitutional AI principles.",
          category: "ai_systems",
          difficulty: "Hard",
          is_critical: true,
          tags: ["ai_safety", "constitutional_ai", "model_deployment", "safety_monitoring"],
          system_design_details: {
            architecture_focus: ["ai_safety_systems", "constitutional_ai", "safety_monitoring", "model_alignment"],
            complexity_level: "senior",
            leadership_aspects: ["ai_safety_culture", "ethical_considerations", "safety_first_mindset"],
            frameworks: ["constitutional_ai", "safety_monitoring", "model_alignment"],
            evaluation_criteria: ["safety_compliance", "model_helpfulness", "harm_prevention", "alignment_quality"],
            estimated_time_minutes: 45,
            follow_up_questions: [
      ...
      questions: [
        {
          ...
          system_design_details: {
            architecture_focus: ["recommendation_systems", "personalization", "content_ranking", "a_b_testing"],
            complexity_level: "senior",
            leadership_aspects: ["content_strategy", "user_engagement", "data_science_collaboration"],
            frameworks: ["collaborative_filtering", "content_based_filtering", "deep_learning"],
            evaluation_criteria: ["engagement_metrics", "content_discovery", "user_satisfaction", "business_impact"],
            estimated_time_minutes: 45,
            follow_up_questions: [
        ...
        {
          question_text: "Design a global video streaming platform with adaptive bitrate.",
          category: "media_streaming",
          difficulty: "Hard",
          is_critical: true,
          tags: ["video_streaming", "adaptive_bitrate", "global_cdn", "quality_optimization"],
          system_design_details: {
            architecture_focus: ["adaptive_streaming", "global_cdn", "video_encoding", "quality_optimization"],
            complexity_level: "senior",
            leadership_aspects: ["global_infrastructure", "user_experience", "cost_optimization"],
            frameworks: ["adaptive_bitrate", "cdn_optimization", "video_encoding"],
            evaluation_criteria: ["streaming_quality", "global_performance", "cost_efficiency", "user_experience"],
            estimated_time_minutes: 45,
            follow_up_questions: [
      ...
      questions: [
        {
          ...
          system_design_details: {
            architecture_focus: ["real_time_matching", "geospatial_systems", "optimization_algorithms", "mobile_systems"],
            complexity_level: "senior",
            leadership_aspects: ["marketplace_dynamics", "user_experience", "operational_efficiency"],
            frameworks: ["geospatial_indexing", "real_time_processing", "optimization_algorithms"],
            evaluation_criteria: ["matching_efficiency", "wait_times", "system_scalability", "user_satisfaction"],
            estimated_time_minutes: 45,
            follow_up_questions: [
    ...
    // Airbnb questions
    {
      ...
      questions: [
        {
          question_text: "Design Airbnb's search and ranking system.",
          category: "search_systems",
          difficulty: "Hard",
          is_critical: true,
          tags: ["search", "ranking", "personalization", "marketplace"],
          system_design_details: {
            architecture_focus: ["search_systems", "ranking_algorithms", "personalization", "marketplace_dynamics"],
            complexity_level: "senior",
            leadership_aspects: ["marketplace_balance", "user_experience", "business_optimization"],
            frameworks: ["search_engines", "ranking_algorithms", "personalization_systems"],
            evaluation_criteria: ["search_relevance", "booking_conversion", "user_satisfaction", "host_fairness"],
            estimated_time_minutes: 45,
            follow_up_questions: [
      ...
      questions: [
        {
          ...
          system_design_details: {
            architecture_focus: ["recommendation_systems", "real_time_personalization", "engagement_optimization", "content_understanding"],
            complexity_level: "senior",
            leadership_aspects: ["content_creator_ecosystem", "user_engagement", "algorithmic_fairness"],
            frameworks: ["deep_learning", "real_time_processing", "content_analysis"],
            evaluation_criteria: ["user_engagement", "content_diversity", "creator_satisfaction", "platform_growth"],
            estimated_time_minutes: 45,
            follow_up_questions: [
    ...
    // LinkedIn questions
    {
      ...
      questions: [
        {
          question_text: "Design LinkedIn's professional network feed algorithm.",
          category: "social_networks",
          difficulty: "Hard",
          is_critical: true,
          tags: ["professional_network", "feed_algorithm", "content_ranking", "networking"],
          system_design_details: {
            architecture_focus: ["social_graph_analysis", "content_ranking", "professional_relevance", "network_effects"],
            complexity_level: "senior",
            leadership_aspects: ["professional_community", "content_quality", "network_growth"],
            frameworks: ["graph_algorithms", "content_ranking", "social_signals"],
            evaluation_criteria: ["professional_relevance", "engagement_quality", "network_growth", "content_value"],
            estimated_time_minutes: 45,
            follow_up_questions: [
    ...
    // Snowflake questions
    {
      ...
      questions: [
        {
          question_text: "Design a cloud-native data warehouse with automatic scaling.",
          category: "data_systems",
          difficulty: "Hard",
          is_critical: true,
          tags: ["data_warehouse", "cloud_native", "auto_scaling", "analytics"],
          system_design_details: {
            architecture_focus: ["cloud_architecture", "auto_scaling", "data_storage", "query_optimization"],
            complexity_level: "senior",
            leadership_aspects: ["data_strategy", "cost_optimization", "performance_engineering"],
            frameworks: ["cloud_architecture", "distributed_storage", "query_engines"],
            evaluation_criteria: ["query_performance", "cost_efficiency", "scalability", "data_freshness"],
            estimated_time_minutes: 45,
            follow_up_questions: [
    ...
    // Scale AI questions
    {
      ...
      questions: [
        {
          question_text: "Design a system for large-scale data labeling and annotation.",
          category: "data_systems",
          difficulty: "Hard",
          is_critical: true,
          tags: ["data_labeling", "annotation", "quality_control", "machine_learning"],
          system_design_details: {
            architecture_focus: ["data_pipeline", "quality_control", "human_in_the_loop", "workflow_management"],
            complexity_level: "senior",
            leadership_aspects: ["data_quality", "human_workforce_management", "ml_pipeline_integration"],
            frameworks: ["workflow_systems", "quality_control", "human_computer_interaction"],
            evaluation_criteria: ["annotation_quality", "throughput", "cost_efficiency", "turnaround_time"],
            estimated_time_minutes: 45,
            follow_up_questions: [
    ...
    // Reddit questions
    {
      ...
      questions: [
        {
          question_text: "Design Reddit's content ranking and moderation system.",
          category: "content_systems",
          difficulty: "Hard",
          is_critical: true,
          tags: ["content_ranking", "moderation", "community", "voting_systems"],
          system_design_details: {
            architecture_focus: ["voting_systems", "content_ranking", "community_moderation", "spam_detection"],
            complexity_level: "senior",
            leadership_aspects: ["community_management", "content_policy", "platform_governance"],
            frameworks: ["ranking_algorithms", "moderation_systems", "community_governance"],
            evaluation_criteria: ["content_quality", "community_health", "engagement", "moderation_effectiveness"],
            estimated_time_minutes: 45,
            follow_up_questions: [
    ...
    // Startups & Scale-ups questions
    {
      ...
      questions: [
        {
          question_text: "Design a scalable system architecture for a fast-growing startup.",
          category: "startup_systems",
          difficulty: "Medium",
          is_critical: true,
          tags: ["startup_architecture", "scalability", "cost_optimization", "rapid_growth"],
          system_design_details: {
            architecture_focus: ["cost_effective_scaling", "rapid_iteration", "technical_debt_management", "team_productivity"],
            complexity_level: "mid",
            leadership_aspects: ["resource_constraints", "rapid_scaling", "technical_decision_making"],
            frameworks: ["lean_architecture", "cloud_first", "iterative_development"],
            evaluation_criteria: ["cost_efficiency", "development_velocity", "scalability_potential", "technical_debt"],
            estimated_time_minutes: 40,
            follow_up_questions: [
        ...
        },
        {
          ...
          system_design_details: {
            architecture_focus: ["mvp_architecture", "scalability_planning", "lean_development", "iteration_speed"],
            complexity_level: "mid",
            leadership_aspects: ["product_strategy", "engineering_efficiency", "market_validation"],
            frameworks: ["lean_startup", "agile_development", "cloud_native"],
            evaluation_criteria: ["time_to_market", "development_cost", "scalability_potential", "iteration_speed"],
  ...
  for (const companyData of systemDesignQuestions) {
    ...
    for (const questionData of companyData.questions) {
      const { system_design_details, ...questionFields } = questionData;
      
      // Transform camelCase fields to snake_case for database
      const transformedFields = {
        id: questionData.question_text.toLowerCase().replace(/[^a-z0-9]+/g, '_').substring(0, 50) + '_' + Math.random().toString(36).substring(2, 8),
      ...
      const transformedSystemDesignDetails = {
        id: question.id + '_system_design',
        architecture_focus: system_design_details.architecture_focus || [],
        complexity_level: system_design_details.complexity_level || 'mid',
        leadership_aspects: system_design_details.leadership_aspects || [],
        frameworks: system_design_details.frameworks || [],
        evaluation_criteria: system_design_details.evaluation_criteria || [],
        resources: system_design_details.resources || [],
        estimated_time_minutes: system_design_details.estimated_time_minutes || 45,
        follow_up_questions: system_design_details.follow_up_questions || [],
        common_mistakes: system_design_details.common_mistakes || [],
        key_tradeoffs: system_design_details.key_tradeoffs || [],
        created_at: new Date(),
        updated_at: new Date()
      };
      ...
      await prisma.system_design_questions.upsert({
        ...
        update: transformedSystemDesignDetails,
        create: {
          question_id: question.id,
          ...transformedSystemDesignDetails
        }
      });
    }
  }
